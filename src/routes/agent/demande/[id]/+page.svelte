		...
		<div class="lg:col-span-2 space-y-4">
			...
			<div class="card">
				...
				<dl class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
					...
					<div><dt class="text-gray-400 text-xs">N° de registre</dt><dd class="font-medium mt-0.5 font-mono">{demande.personne_concernee.numero_registre || '—'}</dd></div>
					<div><dt class="text-gray-400 text-xs">Copies</dt><dd class="font-medium mt-0.5">{demande.copies}</dd></div>
					<div class="col-span-2"><dt class="text-gray-400 text-xs">Mode de réception</dt><dd class="font-medium mt-0.5">{MODE_RECEPTION_LABELS[demande.mode_reception]}</dd></div>
				</dl>
			</div>
